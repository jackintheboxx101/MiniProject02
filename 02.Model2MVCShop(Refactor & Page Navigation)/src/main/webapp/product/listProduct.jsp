...
System.out.println("======listProd.jsp access : " + menu + "========");
%>
...
<body bgcolor="#ffffff" text="#000000">
	...
	<div style="width: 98%; margin-left: 10px;">
		...
		<form name="detailForm" action="/listProduct.do?menu=search"
			method="post">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr class="ct_list_pop">
					...
					<td></td>
					<td align="left"><%=vo.getProTranCode()%> <%-- code를 받아 if로 분류해야 할  --%>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
				 ...
				 <a href="javascript:fncGetProductList('<%=resultPage.getCurrentPage() - 1%>')">◀
											이전</a> <%
				 }
				 %> <%
				 ...
				 %> <a
										href="javascript:fncGetProductList('<%=resultPage.getEndUnitPage() + 1%>')">이후
											▶</a> <%
				 }
				 %></td>
